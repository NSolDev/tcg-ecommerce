...
export default function IntroAnimation({ products = [] }: IntroAnimationProps) {
  ...
  // ═══════════════════════════════════════════════════════════
  const getImageUrl = (product: NonNullable<IntroAnimationProps['products']>[number]) => {
    ...
    return (
      <div className="scroll-morph-hero flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-[#FFCB05] md:text-6xl">TCG Store</h1>
          <p className="mt-4 text-[#B0B0B0]">Cargando experiencia...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="scroll-morph-hero">
      ...
      <div className="hero-content">
        ...
        >
          ...
          <span className="mt-4 block text-xl font-normal text-[#B0B0B0] md:text-2xl lg:text-3xl">
