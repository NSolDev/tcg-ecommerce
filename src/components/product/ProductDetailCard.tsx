...
import { formatPrice, getRarityLabel, getConditionLabel, getCategoryLabel, rarityColors } from '@/lib/utils'
...
export function ProductDetailCard({ product }: ProductDetailCardProps) {
  ...
  const stockColor = product.stock === 0 ? 'product-detail-spec-value-out-of-stock' : product.stock < 5 ? 'product-detail-spec-value-low-stock' : 'product-detail-spec-value-in-stock'
      ...
      <div className="product-detail-info">
        <div>
          <div className="product-detail-badges">
            {rarity && (
              <Badge className={`product-detail-badge ${rarityColors[rarity] || 'product-detail-badge-rarity-comun'}`}>
