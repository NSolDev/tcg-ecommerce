    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      <AlertDialogTrigger asChild>
        <Button
          ...
          className={
            isAdmin
              ? 'border-red-500/20 bg-red-500/10 text-red-400 hover:border-red-500/30 hover:text-red-300'
              : 'border-green-500/20 bg-green-500/10 text-green-400 hover:border-green-500/30 hover:text-green-300'
          }
        >
          ...
          <AlertDialogAction
            ...
            className={
              isAdmin
                ...
                : 'bg-[#FFCB05] text-[#121212] hover:bg-[#E6B800]'
            }
          >
