      ...
      <div className="about-content">
        <div className="about-section">
          ...
          <p className="about-section-text">
            TCG Store nació en 2024 con una misión clara: conectar a coleccionistas de cartas Pokémon 
            con los productos más auténticos y exclusivos del mercado. Lo que empezó como un pequeño 
            proyecto entre amigos se ha convertido en una tienda de referencia para la comunidad TCG.
          </p>
          <p className="about-section-text">
            Creemos que cada carta cuenta una historia, y queremos ser parte de la tuya. Ya seas un 
            coleccionista experimentado o estés empezando tu viaje, en TCG Store encontrarás un espacio 
            donde tu pasión es la protagonista.
          </p>
        </div>
