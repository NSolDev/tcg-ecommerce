...
import { User, Bell, Shield, Globe, Save, Trash2, AlertTriangle } from 'lucide-react';
          ...
          <CardContent className="settings-card-content">
            <div className="settings-toggle">
              <div className="settings-toggle-info">
                ...
                <span className="settings-toggle-description">
                  Recibe confirmaciones de tus pedidos
                </span>
              </div>
            ...
            <div className="settings-toggle">
              <div className="settings-toggle-info">
                ...
                <span className="settings-toggle-description">
                  Recibe información de nuevas colecciones
                </span>
              </div>
              <Switch defaultChecked className="settings-toggle-switch" />
            </div>
        ...
        <Card className="settings-card">
          ...
          <CardContent className="settings-card-content">
            <div className="settings-field">
              <Label htmlFor="language" className="settings-field-label">
                Idioma
              </Label>
            ...
            <div className="settings-field">
              <Label htmlFor="currency" className="settings-field-label">
                Moneda
              </Label>
          ...
          <CardContent className="settings-card-content">
            <div className="settings-security-grid">
              <div className="settings-security-item">
                ...
                <Button variant="outline" className="settings-btn-outline-sm">
                  Cambiar
                </Button>
              </div>
              <Separator className="settings-separator" />
