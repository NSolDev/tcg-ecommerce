            ...
            <div className="shop-footer-grid">
              ...
              <div>
                ...
                <ul className="shop-footer-list">
                  <li><a href="/products" className="shop-footer-link">Catálogo</a></li>
                  <li><a href="/about" className="shop-footer-link">Sobre Nosotros</a></li>
                  <li><a href="/contact" className="shop-footer-link">Contacto</a></li>
                </ul>
              </div>
              <div>
                <h4 className="shop-footer-title">Ayuda</h4>
                <ul className="shop-footer-list">
                  <li><a href="/faq" className="shop-footer-link">FAQ</a></li>
                  <li><a href="/shipping" className="shop-footer-link">Envíos</a></li>
                  <li><a href="/returns" className="shop-footer-link">Devoluciones</a></li>
                </ul>
              </div>
              <div>
